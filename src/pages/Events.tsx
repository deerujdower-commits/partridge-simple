...
const galleryImages: { src: string; alt: string }[] = [
  ...
  { src: galleryBlackRoundGala, alt: 'Partridge Linen black round tablecloths at elegant gala event' },
  ...
  { src: gallerySkyBlueDamaskRound, alt: 'Partridge Linen sky blue damask round tablecloth at elegant event' },
  { src: galleryWhiteWeddingCakeDisplay, alt: 'Partridge Linen white tablecloth at wedding cake display' },
